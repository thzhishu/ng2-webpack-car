import EmployeeListModule from './employeeList'
import EmployeeListController from './employeeList.controller';
import EmployeeListComponent from './employeeList.component';
import EmployeeListTemplate from './employeeList.html';

describe('EmployeeList', () => {
  let $rootScope, makeController;

  beforeEach(window.module(EmployeeListModule.name));
  ...
  describe('Template', () => {
    ...
    it('has name in template [REMOVE]', () => {
      expect(EmployeeListTemplate).to.match(/{{\s?vm\.name\s?}}/g);
    });
  });
