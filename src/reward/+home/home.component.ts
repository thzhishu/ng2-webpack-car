...
import { CORE_DIRECTIVES, NgFor, NgSwitch, NgStyle,
...
import { GroupTypePipe } from '../pipe';
...
@Component({
  ...
  directives: [ROUTER_DIRECTIVES, CORE_DIRECTIVES, NgFor,
   NgSwitch, NgSwitchWhen, NgSwitchDefault, NgStyle],
...
export class HomeComponent {
  ...
  getList() {
    this.hs.get().subscribe(data => this.setList(data), error => this.handleError);
  }
